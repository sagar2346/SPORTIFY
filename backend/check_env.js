...
if (email === 'your.email@gmail.com' || email.includes('your.email')) {
    console.log('⚠️  ALERT: EMAIL_USER is still set to the placeholder "your.email@gmail.com"!');
...
if (pass === 'xxxx xxxx xxxx xxxx' || pass.includes('xxxx')) {
    console.log('⚠️  ALERT: EMAIL_PASS is still set to the placeholder "xxxx xxxx xxxx xxxx"!');
