        ...
        <div className="min-h-screen bg-slate-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="mb-8 md:mb-0">
                            ...
                            <p className="text-primary-100 text-lg">Ready for your next game? Find the perfect court nearby.</p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    <Link to="/venues" className="card group hover:bg-primary-50 border-none ring-1 ring-slate-200">
                        ...
                        <p className="text-slate-500">Browse top-rated courts and fields in your area.</p>
                    </Link>

                    <Link to="/bookings" className="card group hover:bg-secondary-50 border-none ring-1 ring-slate-200">
                        ...
                        <p className="text-slate-500">View upcoming matches and manage bookings.</p>
                    </Link>

                    <Link to="/analytics" className="card group hover:bg-blue-50 border-none ring-1 ring-slate-200">
                        ...
                        <p className="text-slate-500">Check your activity history and preferences.</p>
                    </Link>
                </div>
                        ...
                        <Link key={venue._id} to={`/venues/${venue._id}`} className="group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                            <div className="aspect-w-16 aspect-h-9 h-48">
                                {venue.images?.[0] ? (
                                    ...
                                    <div className="w-full h-full bg-slate-200 flex items-center justify-center"><FiActivity /></div>
                                )}
                            </div>
                            ...
                            <div className="bg-white p-6 border border-t-0 border-slate-100 rounded-b-2xl">
                                <h3 className="text-lg font-bold mb-1 text-slate-800">{venue.name}</h3>
                                <p className="text-slate-500 text-sm mb-4">{venue.location.city}</p>
                                <div className="flex justify-between items-center">
                                    <span className="font-bold text-primary-600 text-lg">${venue.basePrice}<span className="text-sm font-normal text-slate-400">/hr</span></span>
